    ...
    Surface(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    email.value = it
                    emailError.value = if (!isEmailValid) "Enter a valid email address" else ""
                },
                ...
                isError = emailError.value.isNotEmpty(), // Show error
                supportingText = {
                    if (emailError.value.isNotEmpty()) {
                        Text(text = emailError.value, color = Color.Red)
                    }
                },
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    ...
                    passwordError.value = if (!isPasswordValid) {
                        "Password must be 8–15 characters, include upper, lower, and special character."
                    } else ""
                },
                ...
                isError = passwordError.value.isNotEmpty(), // Show error
                supportingText = {
            ...
            Spacer(modifier = Modifier.height(16.dp))
             ...
             Button(
                 onClick = {
                     ...
                     if (!isPasswordValid) {
                         passwordError.value =
                             "Password must be 8–15 chars, with upper, lower & special char."
                     }
